...
async function updateGame(values, cb) {
    ...
    const result = await pool.query(`UPDATE zaidimu_uzsakymai SET fk_zaidimaiid_zaidimai = $1, fk_uzsakymaiid_uzsakymai = $2, kiekis = $3 WHERE id_zaidimu_uzsakymai = $4`,
        [values.fk_zaidimaiid_zaidimai, values.fk_uzsakymaiid_uzsakymai, values.kiekis, values.id_zaidimu_uzsakymai]
    );
