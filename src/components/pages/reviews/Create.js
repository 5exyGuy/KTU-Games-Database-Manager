...
import { PageHeader, Form, Button, Card, Row, Col, Select, DatePicker, Rate } from 'antd';
...
export default class CreateForm extends Component {
	...
	onFinish(values) {
		socket.emit(tables.reviews, 'insert', values, (result) => {
			if (!result) return;
			this.props.back();
		});
    }
                    ...
                    <Col span={12}>
                        <Card style={{ backgroundColor: 'rgb(225, 225, 225)' }}>
                            ...
                            >
                                ...
                                <Form.Item key='skelbti' {...tailFormItemLayout}>
